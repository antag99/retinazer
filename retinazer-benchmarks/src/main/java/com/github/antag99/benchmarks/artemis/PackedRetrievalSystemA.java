...
@Wire
public final class PackedRetrievalSystemA extends EntityProcessingSystem {
    private Blackhole voidness = new Blackhole();
    private ComponentMapper<PackedComponentA> mapper;

    @SuppressWarnings("unchecked")
    public PackedRetrievalSystemA() {
        super(Aspect.all(PackedComponentA.class));
    }

    @Override
    public final void process(Entity entity) {
        PackedComponentA component = mapper.get(entity);
