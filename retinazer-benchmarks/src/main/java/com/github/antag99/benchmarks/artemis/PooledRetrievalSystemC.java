...
@Wire
public final class PooledRetrievalSystemC extends EntityProcessingSystem {
    private Blackhole voidness = new Blackhole();
    private ComponentMapper<PooledComponentC> mapper;

    @SuppressWarnings("unchecked")
    public PooledRetrievalSystemC() {
        super(Aspect.all(PooledComponentC.class));
    }

    @Override
    public final void process(Entity entity) {
        PooledComponentC component = mapper.get(entity);
