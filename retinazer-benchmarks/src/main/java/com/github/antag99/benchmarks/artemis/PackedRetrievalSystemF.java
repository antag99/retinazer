...
@Wire
public final class PackedRetrievalSystemF extends EntityProcessingSystem {
    private Blackhole voidness = new Blackhole();
    private ComponentMapper<PackedComponentF> mapper;

    @SuppressWarnings("unchecked")
    public PackedRetrievalSystemF() {
        super(Aspect.all(PackedComponentF.class));
    }

    @Override
    public final void process(Entity entity) {
        PackedComponentF component = mapper.get(entity);
