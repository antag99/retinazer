...
@Wire
public final class PackedRetrievalSystemB extends EntityProcessingSystem {
    private Blackhole voidness = new Blackhole();
    private ComponentMapper<PackedComponentB> mapper;

    @SuppressWarnings("unchecked")
    public PackedRetrievalSystemB() {
        super(Aspect.all(PackedComponentB.class));
    }

    @Override
    public final void process(Entity entity) {
        PackedComponentB component = mapper.get(entity);
