...
public final class RetrievalSystemB implements EntreriSystem {
    private Blackhole voidness = new Blackhole();
    private ComponentIterator iterator;
    private ComponentB component;

    public RetrievalSystemB(EntitySystem entitySystem) {
        this.iterator = entitySystem.fastIterator();
        this.component = iterator.addRequired(ComponentB.class);
    }

    @Override
    public void process() {
        ComponentB component = this.component;
