...
@Wire
public final class PooledRetrievalSystemA extends EntityProcessingSystem {
    private Blackhole voidness = new Blackhole();
    private ComponentMapper<PooledComponentA> mapper;

    @SuppressWarnings("unchecked")
    public PooledRetrievalSystemA() {
        super(Aspect.all(PooledComponentA.class));
    }

    @Override
    public final void process(Entity entity) {
        PooledComponentA component = mapper.get(entity);
