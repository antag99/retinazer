...
@Wire
public final class PackedRetrievalSystemH extends EntityProcessingSystem {
    private Blackhole voidness = new Blackhole();
    private ComponentMapper<PackedComponentH> mapper;

    @SuppressWarnings("unchecked")
    public PackedRetrievalSystemH() {
        super(Aspect.all(PackedComponentH.class));
    }

    @Override
    public final void process(Entity entity) {
        PackedComponentH component = mapper.get(entity);
