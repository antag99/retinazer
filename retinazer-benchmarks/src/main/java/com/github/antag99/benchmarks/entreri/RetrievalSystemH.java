...
public final class RetrievalSystemH implements EntreriSystem {
    private Blackhole voidness = new Blackhole();
    private ComponentIterator iterator;
    private ComponentH component;

    public RetrievalSystemH(EntitySystem entitySystem) {
        this.iterator = entitySystem.fastIterator();
        this.component = iterator.addRequired(ComponentH.class);
    }

    @Override
    public void process() {
        ComponentH component = this.component;
