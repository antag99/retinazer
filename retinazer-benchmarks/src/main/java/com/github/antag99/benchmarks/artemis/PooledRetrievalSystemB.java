...
@Wire
public final class PooledRetrievalSystemB extends EntityProcessingSystem {
    private Blackhole voidness = new Blackhole();
    private ComponentMapper<PooledComponentB> mapper;

    @SuppressWarnings("unchecked")
    public PooledRetrievalSystemB() {
        super(Aspect.all(PooledComponentB.class));
    }

    @Override
    public final void process(Entity entity) {
        PooledComponentB component = mapper.get(entity);
