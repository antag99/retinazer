...
@Wire
public final class PooledRetrievalSystemH extends EntityProcessingSystem {
    private Blackhole voidness = new Blackhole();
    private ComponentMapper<PooledComponentH> mapper;

    @SuppressWarnings("unchecked")
    public PooledRetrievalSystemH() {
        super(Aspect.all(PooledComponentH.class));
    }

    @Override
    public final void process(Entity entity) {
        PooledComponentH component = mapper.get(entity);
