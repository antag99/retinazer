...
mvn install -DskipTests=true -Dartemis.optimizeEntitySystems=true | \
...
mvn install -DskipTests=true -Dartemis.optimizeEntitySystems=false -Dartemis.enablePooledWeaving=true | \
...
mvn install -DskipTests=true -Dartemis.optimizeEntitySystems=false -Dartemis.enablePackedWeaving=true | \
...
mvn install -DskipTests=true -Dartemis.optimizeEntitySystems=true -Dartemis.enablePooledWeaving=true | \
...
mvn install -DskipTests=true -Dartemis.optimizeEntitySystems=true -Dartemis.enablePackedWeaving=true | \
